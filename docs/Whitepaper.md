...
- Share purchase: The share of Great Participants follow the function $\rm \scriptsize S=D*\sqrt{I}$, where $\rm \scriptsize D$ is DGT held and $\rm \scriptsize I$ is the investment.
